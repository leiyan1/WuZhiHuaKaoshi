...
using System.IO;
public partial class AdminC_SingleSelectLists : System.Web.UI.Page
{
    ...
    protected void GvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from SingleProblem  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [SingleProblem] ";
