...
using System.IO;
public partial class AdminC_PageManger : System.Web.UI.Page
{
    ...
    protected void GvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from Paper  where  PaperID='" + ID + "'");
            mydata.RunSql("delete  from PaperDetail  where  PaperID='" + ID + "'");
            Label4.Text = "删除成功！";
            GvInfo.EditIndex = -1;
            Get_Info();
        }
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Paper] ";
