<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddChapter.aspx.cs" Inherits="AdminC_AddChapter" %>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;
                  ...
                  <tr>
                      <td align="right" style="width: 97px; height: 25px">
                          任课教师 ：</td>
                      <td style="height: 25px">
                          <asp:DropDownList ID="dlTeachter" runat="server" Font-Size="9pt" Width="268px">
                          </asp:DropDownList></td>
                  </tr>
