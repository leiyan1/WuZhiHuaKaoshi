<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teachtermanger.aspx.cs" Inherits="AdminC_Teachtermanger" %>
                          ...
                          <asp:TemplateField HeaderText="姓名">
                            ...
                            <asp:TemplateField HeaderText="密码">
                              ...
                              <asp:TemplateField HeaderText="电子邮件">
                                <ItemTemplate>
                                    <asp:Label ID="userEmal" runat="server" Text='<%# Bind("userEmal") %>' Width="125px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
