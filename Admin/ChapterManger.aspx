<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChapterManger.aspx.cs" Inherits="AdminC_ChapterManger" %>
              ...
              <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  ...
                  <Columns>
                      <asp:TemplateField HeaderText="考试科目名称">
                          <ItemTemplate>
                              <asp:Label ID="Name" runat="server" Text='<%# Bind("Name") %>' Width="69px"></asp:Label>
                          </ItemTemplate>
                          <ItemStyle HorizontalAlign="Left" Width="80px" />
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="任课教师">
                          <ItemTemplate>
                              <asp:Label ID="TeachterName" runat="server" Text='<%# Bind("TeachterName") %>' Width="69px"></asp:Label>
                          </ItemTemplate>
                          <ItemStyle HorizontalAlign="Left" Width="80px" />
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="考试科目描述">
                          <ItemTemplate>
                              <asp:Label ID="Ds" runat="server" Text='<%# Bind("Ds") %>' Width="533px"></asp:Label>
                          </ItemTemplate>
                          <ItemStyle HorizontalAlign="Left" Width="80px" />
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="修改">
                          <ItemTemplate>
                              <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyChapter.aspx?id="+Eval("id") %>'
