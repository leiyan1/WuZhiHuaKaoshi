<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSingleSelect.aspx.cs" Inherits="AdminC_AddSingleSelect" %>
        ...
        <TR>
          <TD align="left" style="height: 2px">
              <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;
                  ...
                  <tr>
                      <td align="center" style="width: 68px; height: 18px;">
                          考试科目：</td>
                      <td style="height: 18px">
                          <asp:DropDownList ID="ddlCourse" runat="server" Font-Size="9pt" Width="279px">
                          </asp:DropDownList></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      <td align="center" nowrap="nowrap" style="width: 68px">
                          答案A：</td>
                      <td>
                  ...
                  <tr>
                      <td align="center" style="width: 68px; height: 59px">
                          答案D：</td>
                  ...
                  <tr>
                      <td align="center" height="10" style="width: 68px">
                          答案：</td>
                      <td>
