<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlankProblemList.aspx.cs" Inherits="AdminC_BlankProblemList" %>
              ...
              <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  ...
                  <Columns>
                      ...
                      <asp:TemplateField HeaderText="查看">
                          <ItemTemplate>
                              <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "AddAddBlankProblem.aspx?id="+Eval("id") %>'
