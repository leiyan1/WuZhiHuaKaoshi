<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPage.aspx.cs" Inherits="AdminC_AddPage" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>当前位置：添加试卷信息 </TD></TR>
        <TR>
          ...
          <table align="center" border="0" cellpadding="0"
                        ...
                        <tr style="color: #000000">
                            ...
                            <td style="height: 35px; width: 294px;" align="left">
                                <asp:TextBox ID="TextBox1" runat="server" Width="80px" ReadOnly="True">5</asp:TextBox></td>
                        </tr>
              <tr style="color: #000000">
                  <td align="left" style="width: 97px; height: 34px">
                      多选题数量：</td>
                  <td align="left" style="width: 294px; height: 34px">
                      <asp:TextBox ID="TextBox2" runat="server" Width="80px" ReadOnly="True">5</asp:TextBox></td>
              </tr>
              <tr style="color: #000000">
                  <td align="left" style="width: 97px; height: 34px">
                      判断题数量：</td>
                  <td align="left" style="width: 294px; height: 34px">
                      <asp:TextBox ID="TextBox6" runat="server" Width="80px" ReadOnly="True">5</asp:TextBox></td>
              </tr>
              <tr style="color: #000000">
                  <td align="left" style="width: 97px; height: 34px">
                      填空题数量：</td>
                  <td align="left" style="width: 294px; height: 34px">
                      <asp:TextBox ID="TextBox3" runat="server" Width="80px" ReadOnly="True">5</asp:TextBox></td>
              </tr>
              <tr style="color: #000000">
                  <td align="left" style="width: 97px; height: 34px">
                      试题总分：</td>
                  <td align="left" style="width: 294px; height: 34px">
                      <asp:TextBox ID="TextBox5" runat="server" ReadOnly="True" Width="116px">100</asp:TextBox></td>
              </tr>
              ...
              <tr align="center" height="55">
                  <td align="left" colspan="2">
                                      ...
                                      <table id="Table3" align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
                                          ...
                                          <tr>
                                              <td style="height: 22px" width="35%">
                                                  <asp:CheckBox ID="CheckBox1" runat="server" Enabled="False" Text='<%# Eval("AnswerA") %>' /></td>
                                              <td style="height: 22px" width="35%">
                                                  <asp:CheckBox ID="CheckBox2" runat="server" Enabled="False" Text='<%# Eval("AnswerB") %>' /></td>
                                              <td style="height: 22px">
                                              </td>
                                          </tr>
                                          <tr>
                                              <td width="35%">
                                                  <asp:CheckBox ID="CheckBox3" runat="server" Enabled="False" Text='<%# Eval("AnswerC") %>' /></td>
                                              <td width="350%">
                                                  <asp:CheckBox ID="CheckBox4" runat="server" Enabled="False" Text='<%# Eval("AnswerD") %>' /></td>
                                              <td>
                                              </td>
                                          </tr>
                                      </table>
                      ...
                      <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4"
                          ...
                          <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                          <Columns>
                              <asp:TemplateField HeaderText="四、填空题目">
                                  <ItemTemplate>
              ...
              <tr align="center" height="55">
                  <td align="center" colspan="2" style="height: 31px">
                      <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="生成试卷" /></td>
              </tr>
                    </table>
          </TD></TR></TABLE>
      </TD>
