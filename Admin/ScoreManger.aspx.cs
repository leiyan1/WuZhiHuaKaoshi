...
using System.IO;
public partial class AdminC_ScoreManger : System.Web.UI.Page
{
    ...
    protected void GvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from Score  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        sql = "select  " + strTop + " a.Score+a.FullScorre as addscore , * from Score a left join  Paper b on a.PaperID=b.PaperID left join Users c on a.UserID=c.UserID ";
