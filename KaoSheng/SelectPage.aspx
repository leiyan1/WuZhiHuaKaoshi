<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectPage.aspx.cs" Inherits="UserC_SelectPage" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              当前位置：您随机分配的试卷信息如下</TD></TR>
        <TR>
          <TD align="left">
              <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  BackColor="White" CellPadding="5" DataKeyNames="PaperID" OnPageIndexChanging="GvInfo_PageIndexChanging"
                  ...
                  <Columns>
                      <asp:TemplateField HeaderText="试卷名称">
                          <ItemTemplate>
                              <asp:Label ID="PaperName" runat="server" Text='<%# Bind("PaperName") %>' Width="69px"></asp:Label>
                          </ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="进入考试页面">
                          <ItemTemplate>
                              <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ShowPage.aspx?id="+Eval("PaperID") %>'
                                  Text="进入考试页面" Width="75px"></asp:HyperLink>
                          </ItemTemplate>
