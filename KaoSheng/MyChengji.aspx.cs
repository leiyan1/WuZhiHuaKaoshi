...
using System.IO;
public partial class UserC_MyChengji : System.Web.UI.Page
{
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + " a.Score+a.FullScorre as addscore , * from Score a left join  Paper b on a.PaperID=b.PaperID left join Users c on a.UserID=c.UserID  where  a.UserID='" + Session["UserId"].ToString() + "'";
