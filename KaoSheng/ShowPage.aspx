<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowPage.aspx.cs" EnableEventValidation = "false"   Inherits="UserC_ShowPage" %>
...
if(seconds==0) 
{ 
//window.location.href="Default.aspx";//转到登陆页 
...
window.setInterval(sessionTimeout,500); 
</script>
</head>
<body>
              ...
              <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                  <tr>
                      <td align="center" colspan="4" nowrap="nowrap" style="height: 28px">
                          试卷名称：<asp:Label ID="lblPaperName" runat="server"></asp:Label>
                          试卷总分数：<asp:Label ID="Label15" runat="server"></asp:Label>&nbsp;
                          <br />
                          请注意考试时间是：<asp:Label ID="lbltiime" runat="server" Text="60"></asp:Label>
                          分钟&nbsp; 剩余时间：
                          <input id="lblTime" runat="server" name="lblTime" style="border-top-width: 0px; border-left-width: 0px;
                              border-bottom-width: 0px; width: 61px; border-right-width: 0px" type="text" />
                          秒</td>
                  </tr>
                  <tr>
                                          ...
                                          <table id="Table3" align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
                                              <tr>
                                                  <td colspan="3">
                                                      ...
                                                      <asp:Label ID="PanDuanProblem" runat="server" Text='<%# Eval("Answer") %>' Visible="False">
									                </asp:Label>
                                                      本题分数：
                                  ...
                                  <asp:TemplateField>
                                      ...
                                      <ItemTemplate>
                                          <table id="Table4" align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
                                              ...
                                              <tr>
                                                  <td width="35%">
                                                      <asp:TextBox ID="TextBox1" runat="server" Height="26px" Width="100%"></asp:TextBox></td>
                                              </tr>
                                          </table>
                                      </ItemTemplate>
                                  </asp:TemplateField>
