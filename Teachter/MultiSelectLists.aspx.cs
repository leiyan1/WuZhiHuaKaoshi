...
using System.IO;
public partial class AdminC_MultiSelectLists : System.Web.UI.Page
{
    ...
    protected void GvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from MultiProblem  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [MultiProblem] ";
