<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAddBlankProblem.aspx.cs" Inherits="AdminC_AddAddBlankProblem" %>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;
                  ...
                  <tr>
                      <td align="center" style="width: 85px">
                          考试科目：</td>
                      <td>
                          <asp:DropDownList ID="ddlCourse" runat="server" Font-Size="9pt" Width="269px">
                          </asp:DropDownList></td>
                  </tr>    
                  <tr>
                  ...
                  <tr>
                      <td align="center" style="width: 69px">
                          题目：</td>
                      <td>
                          <asp:TextBox ID="txtTitle" runat="server" Height="103px" TextMode="MultiLine" Width="309px"></asp:TextBox>
                      </td>
                  </tr>
                  <tr>
                      <td align="center" style="width: 69px; height: 77px">
                          答案：</td>
                      <td style="height: 77px">
                          <asp:TextBox ID="txtAnswer" runat="server" Height="116px" TextMode="MultiLine" Width="310px"></asp:TextBox>
