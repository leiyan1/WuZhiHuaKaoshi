<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyPwd.aspx.cs" Inherits="AdminC_ModifyPwd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>建筑造价工程师考试程序设计</title>
              ...
              <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                  <tr>
                      <td align="left" nowrap="nowrap" style="width: 95px">
                          原密码:</td>
                      <td width="35%">
                          <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="139px"></asp:TextBox></td>
