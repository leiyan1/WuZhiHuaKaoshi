<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SingleSelectLists.aspx.cs" Inherits="AdminC_SingleSelectLists" %>
              ...
              <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  ...
                  <Columns>
                      ...
                      <asp:TemplateField HeaderText="查看">
                          <ItemTemplate>
                              <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "AddSingleSelect.aspx?id="+Eval("id") %>'
