<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PanDuanProblemManger.aspx.cs" Inherits="Admin_PanDuanProblemManger" %>
              ...
              <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  ...
                  <Columns>
                      <asp:TemplateField HeaderText="考试题目">
                          <ItemTemplate>
                              <asp:Label ID="Title" runat="server" Text='<%# Bind("Title") %>' Width="419px"></asp:Label>
                          </ItemTemplate>
                          <ItemStyle HorizontalAlign="Left" Width="80px" />
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="分数">
                          <ItemTemplate>
                              <asp:Label ID="Mark" runat="server" Text='<%# Bind("Mark") %>' Width="89px"></asp:Label>
                          </ItemTemplate>
                          <ItemStyle HorizontalAlign="Left" Width="80px" />
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="答案">
                          <ItemTemplate>
                              <asp:Label ID="Answer" runat="server" Text='<%# Bind("Answer") %>' Width="89px"></asp:Label>
                          </ItemTemplate>
                          <ItemStyle HorizontalAlign="Left" Width="80px" />
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="查看">
                          <ItemTemplate>
                              <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "AddPanDuan.aspx?id="+Eval("id") %>'
